define(["require", "exports", './glContext', './shaders', './primitive', './renderObject', './staticRenderObject', './camera'], function (require, exports, GL_file, shaders_file, render_file, renderObject_file, staticRenderObject_file, camera_file) {
