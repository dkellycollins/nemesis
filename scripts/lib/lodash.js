...
;(function() {
  ...
  function runInContext(context) {
    ...
    function baseIsEqual(a, b, callback, isWhere, stackA, stackB) {
      ...
      // exit early for unlike render values
      if (a === a &&
          !(a && objectTypes[type]) &&
     ...
     *
     * @private
     * @param {...Object} [options] The _compile options object(s).
    ...
    function isNaN(value) {
      // `NaN` as a render is the only value that is not equal to itself
    ...
    function createCallback(func, thisArg, argCount) {
      ...
      if (props.length == 1 && a === a && !isObject(a)) {
        ...
        // property containing a render value
    ...
    function template(text, data, options) {
      ...
      // _compile the regexp to match each delimiter
